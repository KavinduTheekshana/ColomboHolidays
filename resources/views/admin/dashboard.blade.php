                        ...
                        <ul class="list-unstyled list-inline text-center">
                            <li class="list-inline-item mt-2">
                                <span class="text-muted font-13"><i
                                        class="mdi mdi-checkbox-blank-circle mr-2 text-info"></i>In-Store
                                </span>
                            </li>
                            <li class="list-inline-item mt-2">
                                <span class="text-muted font-13"><i
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-4 align-self-center">
                                <p class="text-muted font-13 mb-1"><i
                                        class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i>India
                                ...
                                <p class="text-muted font-13 mb-1"><i
                                        class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i>USA
                                ...
                                <p class="text-muted font-13 mb-1"><i
                                        class="mdi mdi-checkbox-blank-circle mr-2 text-danger"></i>Russia
