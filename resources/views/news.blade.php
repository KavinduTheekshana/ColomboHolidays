		...
		<div class="blog-grid row">
			...
			<div class="blog-grid-entry col-mob-12 col-xs-12 col-sm-6 col-md-4">
				<div class="s_news-entry style-2">
					<a href="blog_detail.html"><img class="s_news-img img-responsive" src="img/inner/blog_grid_1.jpg"
							alt=""></a>
					...
					<a href="blog_detail.html" class="c-button small bg-dr-blue-2 hv-dr-blue-2-o"><span>view
							more</span></a>
				</div>
			</div>
